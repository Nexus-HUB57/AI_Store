...
import {
  Zap, Download, Star, Activity, ExternalLink, Cpu,
  ShoppingCart, ArrowLeft, Clock, Gift, Tag,
} from 'lucide-react'
...
export default function ProductPageClient({ product, initialReviewCount }: Props) {
  ...
  const fetchReviews = useCallback(async () => {
    try {
      ...
      setTotalReviews(data.total || initialReviewCount)
    } catch {}
